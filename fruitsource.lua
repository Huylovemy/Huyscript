if (game:GetService("CoreGui")):FindFirstChild("Bearhud") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).Bearhud:Destroy();
...
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("Bearhud")).Enabled = not (game.CoreGui:FindFirstChild("Bearhud")).Enabled;
end);
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Bearhud") then
			makefolder("Bearhud");
		end;
		if not isfolder("Bearhud/Library/") then
			makefolder("Bearhud/Library/");
		end;
		if not isfile(("Bearhud/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("Bearhud/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("Bearhud/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("Bearhud/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("Bearhud/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	local Bearhud = Instance.new("ScreenGui");
	Bearhud.Name = "Bearhud";
	Bearhud.Parent = game.CoreGui;
	Bearhud.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = Bearhud;
